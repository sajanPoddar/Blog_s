		...
		<div id="top">
			...
			<div class="right">
				<div class="align-right">
					<p>Last login: <strong><?php?></strong></p>
				</div>
			</div>
		</div>
		<div id="nav">
			<ul>
				...
				<li class="upp"><a href="#">Users</a>
					<ul>
                                            <li>&#8250; <a href="<?php echo base_url();?>super_admin/show_user">Show all uses</a></li>
                                                <li>&#8250; <a href="<?php echo base_url();?>super_admin/add_new">Add new user</a></li>
				...
				<li class="upp"><a href="#">Settings</a>
					<ul>
						...
						<li>&#8250; <a href="">Contact Form</a></li>
                            ...
                            <ul> <li class="upp"><a href="<?php echo base_url();?>super_admin/add_category">Add Category</a></li></u1>
			</ul>
		</div>
	</div>
